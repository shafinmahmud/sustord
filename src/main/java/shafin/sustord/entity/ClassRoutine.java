...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "ClassRoutine.findAll", query = "SELECT c FROM ClassRoutine c"),
...
public class ClassRoutine implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.classRoutineId == null && other.classRoutineId != null)
				|| (this.classRoutineId != null && !this.classRoutineId.equals(other.classRoutineId))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "shafin.sustord.ClassRoutine[ classRoutineId=" + classRoutineId + " ]";
	}
