...
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CourseRegistration.findAll", query = "SELECT c FROM CourseRegistration c"),
...
public class CourseRegistration implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.courseRegistrationId == null && other.courseRegistrationId != null)
				|| (this.courseRegistrationId != null
						&& !this.courseRegistrationId.equals(other.courseRegistrationId))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "shafin.sustord.CourseRegistration[ courseRegistrationId=" + courseRegistrationId + " ]";
	}
